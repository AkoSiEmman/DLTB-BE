...
declare class TORMainRepository {
    GetAllTORMain(): Promise<{}>;
    CreateNewTORMain(newTor: any): Promise<boolean>;
    SearchTORMainPerUUID(UUID: string): Promise<{}>;
    UpdateTORMainPerUUID(tor: ITORMAIN): Promise<boolean>;
}
declare const _default: TORMainRepository;
