...
const EmailOTPRoutes_1 = __importDefault(require("./routes/EmailOTPRoutes"));
const DeviceRoutes_1 = __importDefault(require("./routes/DeviceRoutes"));
const CooperativeRoutes_1 = __importDefault(require("./routes/CooperativeRoutes"));
...
app.use(urlBackend, EmailOTPRoutes_1.default);
app.use(urlBackend, DeviceRoutes_1.default);
app.use(urlBackend, CooperativeRoutes_1.default);
